...
from sklearn.metrics import classification_report, confusion_matrix, roc_auc_score, roc_curve, precision_score, recall_score, f1_score, accuracy_score,auc
...
# Model Performance page
    ...
    st.code(precision_score(y_test, y_pred))
    st.code(recall_score(y_test, y_pred))
    st.code(f1_score(y_test, y_pred))
    ...
    with st.form("transaction_form"):
        ...
        with col1:
            step = st.number_input("Hour of Transaction (1-744)", 
                                  min_value=1, max_value=744, value=10)
